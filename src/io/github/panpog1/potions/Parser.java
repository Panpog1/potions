...
public class Parser {
	...
	Compound parseIf(String s, int offset) throws CompoundParseException {
		...
		List<Compound> parts = parseParts(offset, tokens);
	...
	private List<Compound> parseParts(int offset, List<String> tokens)
	...
	private Compound checkConstIdgNames(String s, int offset)
			throws CompoundParseException {
